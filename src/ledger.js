...
const UNLOCKS=[
  ...
  {id:'azzurra',kind:'plate',name:'Blue prepared paper',latin:'Charta azzurra',stat:'grazes',threshold:25,
  ...
  {id:'sanguine',kind:'trail',name:'Red chalk',latin:'Creta sanguinea',stat:'maxSpeedSlings',threshold:10,
  ...
  {id:'ultramarine',kind:'trail',name:'Ultramarine',latin:'Azurrum ultramarinum',stat:'badAngles',threshold:500,
  ...
  {id:'perfecti',kind:'medal',name:'Three perfect transfers',latin:OBSERVATIONS.perfectThree.latin,test:l=>(l.observations.perfectThree||0)>0,
    describe:()=>'Make three perfect transfers in a row'},
  {id:'quinque',kind:'medal',name:'Five orbits skipped',latin:OBSERVATIONS.skipFive.latin,test:l=>(l.observations.skipFive||0)>0,
    describe:()=>'Skip five orbits in one flight'},
  {id:'summa',kind:'medal',name:'The chart’s top speed',latin:OBSERVATIONS.maxSpeed.latin,test:l=>(l.observations.maxSpeed||0)>0,
    describe:()=>'Reach the chart’s top speed'},
  {id:'periculum',kind:'medal',name:'A graze at full speed',latin:OBSERVATIONS.graze.latin,test:l=>(l.observations.graze||0)>0,
    describe:()=>'Graze a vortex at full speed'},
  {id:'pura',kind:'medal',name:'A perfect constellation',latin:OBSERVATIONS.pureChart.latin,test:l=>(l.observations.pureChart||0)>0,
    describe:()=>'Trace a constellation in perfect transfers alone'},
  {id:'altitudo',kind:'medal',name:'The fortieth row',latin:OBSERVATIONS.fortyRows.latin,test:l=>(l.observations.fortyRows||0)>0,
    describe:()=>'Reach row 40'},
  {id:'vigilia',kind:'medal',name:'Three minutes aloft',latin:OBSERVATIONS.threeMinutes.latin,test:l=>(l.observations.threeMinutes||0)>0,
    describe:()=>'Survive three minutes in one run'},
  {id:'rectus',kind:'medal',name:'A right angle of arrival',latin:OBSERVATIONS.rightAngle.latin,test:l=>(l.observations.rightAngle||0)>0,
