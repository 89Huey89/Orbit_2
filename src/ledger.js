...
const UNLOCKS=[
  ...
  {id:'quill',kind:'mark',name:'Quill',latin:'Penna',stat:'perfects',threshold:400,
    describe:()=>'Make 400 perfect transfers'},
  {id:'moth',kind:'mark',name:'Moth',latin:'Phalæna',stat:'perfects',threshold:1000,
    describe:()=>'Make 1,000 perfect transfers'},
  {id:'saturn',kind:'mark',name:'Saturn with handles',latin:'Saturnus ansatus',stat:'perfects',threshold:2500,
    describe:()=>'Make 2,500 perfect transfers'},
...
const COSMETIC_KINDS=[
  ...
  {kind:'mark',title:'Observer marks',latin:'Signa observatoris',fallback:'comet',
    stock:[{id:'comet',name:'Comet',latin:'Cometa'}]},
