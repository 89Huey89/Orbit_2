/* Orbit · scripts/figures.mjs
   ...
   Art, public-domain/Open Access — see docs/archive/eras/03-ceiling.md, "The documents") and the ink masks
...
/* Orbit · src/figures-tt353.js
   ...
   of Art, public-domain/Open Access (recorded in docs/archive/eras/03-ceiling.md, "The documents").
