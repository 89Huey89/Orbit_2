/* Orbit · scripts/signs.mjs
   ...
   *are* cleanly isolated (mostly on the ruled divider line, where whitespace already does the
   ...
   public-domain/Open Access (recorded in docs/archive/eras/03-ceiling.md, "The documents"). */
...
SIGN_BOXES = [
    ...
    ('eyeOverBowl',  'divider', (1314, 1223, 1531, 1375)), # a lens shape stacked on a bowl -- two
                                                            ...
                                                            # stacking docs/archive/eras/03-ceiling.md's
...
/* Orbit · src/signs-tt353.js
   ...
   Museum of Art, public-domain/Open Access (recorded in docs/archive/eras/03-ceiling.md, "The documents").
