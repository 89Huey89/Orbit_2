...
// booting a page: what a Journey run banks, what it never banks, and what the document survives.
{
  ...
  const load=(seed={},over={})=>{
    ...
    vm.runInContext(journeySource+'\nthis.j={get doc(){return journey},get run(){return journeyRun},set mode(m){runMode=m},journeyObserve,journeyCommit,journeyReset,journeyMilestones,journeyReady,resetJourneyRun,ERA_THRESHOLD,JOURNEY_KEY};',context);
