...
// strike and emboss of a perfect landing, a constellation's second colour at three points of its sweep,
// and the blot a hazard death leaves. Each is staged on the traveller's own ring or the nearest figure.
export default {
  name:'press',
  description:'The strike, the second colour and the hazard blot, forced mid-run on night and paper.',
