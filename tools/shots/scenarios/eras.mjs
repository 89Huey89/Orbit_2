...
export default {
  name:'eras',
  description:'Era I (rock), Era II (ceiling), Era III (scroll), Era IV (astrolabe) and Era VI (lens): frontispiece, flight, and end leaf.',
  defaults:{era:['rock','ceiling','scroll','astrolabe','lens']},
  async run(g){
