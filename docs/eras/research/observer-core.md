...
- **The von Neumann probe's scavenged-parts silhouette (§2.8) is proposed, not attested**, and is the
  ...
  [`docs/eras/prototypes/`](../prototypes/) already does for the shipped nine-era plan's own late
  entries.
...
- Repository sources read directly this session: [`README.md`](../../../README.md),
  ...
  [`docs/eras/ERA-AUDIT.md`](../ERA-AUDIT.md), [`docs/eras/OVERVIEW.md`](../OVERVIEW.md),
  [`docs/eras/research/globe.md`](globe.md), [`docs/eras/research/rock.md`](rock.md).
