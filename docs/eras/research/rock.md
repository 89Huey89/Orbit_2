...
**Palaeolithic and Neolithic, c. 40,000–3,000 BCE.** No existing era file to deepen; this is the
first pass. Everything below is checked against the sources in §13; contested readings are kept
and marked contested rather than dropped, because the contest is itself the most honest thing
this era has to say about "reading the sky in deep prehistory."

`OVERVIEW.md`'s rule 2 — "every era speaks in its own hand" — is hardest to satisfy here, for a
reason worth stating up front: **every other era has writing**, and this one has none. That is
the design problem this document exists to solve, and it shapes every section below more than
any single artefact does.
...
Real pigments only; nothing here is a modern paint colour standing in for one.

| Material | Hex (approx.) | Notes |
|---|---|---|
| Red ochre (haematite, Fe₂O₃) | `#9C3B22` | The era's most saturated, most reserved colour — closest thing it has to a "gold." Iron content varies the exact hue site to site. |
| Yellow ochre (goethite/limonite) | `#C9962E` | Softer, more common than red; the two ochres are often the same mineral at different oxidation states. |
| Manganese black (MnO₂) | `#211F1E` | A cooler, slightly blue-black; found ground and mixed with a binder. |
| Charcoal black | `#2C2622` | Warmer, softer-edged than manganese black; the two blacks are chemically and visually distinguishable under analysis. |
| Kaolin white | `#EAE1CF` | White clay, the rarest and most occasional of the four pigment minerals; used sparingly for highlight. |
| Torchlit limestone (ground, Lascaux) | `#C7BC9E` | Pale grey-buff, warmed by flame; the actual colour of the rock the whole palette sits on. |
...
|---|---|---|---|---|
| Ocean world | An undulating engraved line | Flint-scored, continuous | A widely attested abstract "serpentiform" sign | Mark attested; meaning constructed |
| Crater world | A cup mark | Pecked hollow, stone-on-stone | The single most common Neolithic non-figurative motif; a pitted disc is already a crater | Mark attested (Neolithic/Bronze Age; earliest examples fall late in this era); meaning constructed |
| Ringed world | A cup-and-ring mark | Pecked cup, then one or more pecked concentric rings around it | Already, literally, a ringed disc | Mark attested; meaning constructed |
| Ice world | Bare kaolin-washed rock ("reserve") | The pigment withheld, not applied | Painters left rock bare as a value throughout the era; unmarked-as-cold is a natural read | Technique attested (the "reserve"); application constructed |
| Dune world | Finger-combed ochre flutings | Fingers raked through a wet wash | The "macaroni"/fluting technique, usually seen in soft clay or crust | Mark attested; application constructed |
| Volcanic world | Red ochre ground, black fissure-veins | Wash, then scored lines | Red is the era's most reserved pigment; black veining over red is common on multi-colour panels | Palette attested; composition constructed |
| Storm world | A cluster of short comma-strokes | Rapid, undirected burin marks | Drawn from the era's own catalogue of unread geometric signs at Lascaux (~50, meaning unrecovered) | Sign-class attested; specific meaning constructed |
| Attractor (VORAGO) | The spiral | Pecked, concentric, unbroken | Newgrange/Knowth's own emblem; "draws inward" reads directly off the shape. The real meaning of megalithic spirals is unrecovered — this is a game meaning laid over an attested mark | Mark attested; meaning constructed |
| Repulsor (MACULA) | A radiating cup mark | Pecked cup with grooves radiating outward | A rarer cup-and-ring variant, radial rather than concentric | Mark attested (rare); meaning constructed |
| Crosswind (VENTUS) | A streaked charcoal smear | Charcoal dragged, not stroked | No attested "wind" sign exists from this era; drawn from the physical fact that charcoal smears when disturbed | Fully constructed |
| Nebula (obscurer) | The unlit rock beyond torch-reach | Nothing drawn at all | The era's own darkness, not a motif standing for it | Fully attested as a condition of viewing; not a "mark" at all |
| Orbit | A dot-ring | A circle of dab-marks around a point | Dot arrangements framing a figure are attested; the closed ring is constructed | Mark class attested; composition constructed |
| Capture | A hand stencil laid down | Pigment blown around a placed hand | Contact claims the spot | Fully constructed |
| Release | The hand lifted, pigment settling | The blown cloud disperses once the hand is gone | The stencil's negative space is what remains | Fully constructed |
| Ink (currency) | Ochre | The pigment itself | No translation needed — the resource *is* the material | Attested |
| Score | The tally | The notch count on a bone or plaquette | Direct: what a tally bone already does | Attested |
| Chapter / sheet | The chamber | A cave's named gallery (Rotunda, Nave, Apse, Shaft at Lascaux) | These French names are modern speleology, not period vocabulary — flagged, not hidden | Modern label on an attested space; not period-attested |
| The run | One torch | From strike to gutter | Torch relight/wipe marks on cave walls are used by archaeologists to estimate visit lengths; a torch's burn is a real, finite unit this era lived by | Technique attested generally in French cave archaeology (specific citation not independently re-verified this pass — flag for follow-up) |
| Personal best | How deep the torch carried you | Distance from daylight | Some of the era's most significant panels (Lascaux's Shaft, Chauvet's End Chamber) are the hardest to reach — depth was real risk, not metaphor | Constructed application of an attested fact |
| Daily plate | — | — | The era counted *months* (the tally bones), not days; a fixed calendar day is a Neolithic-and-later idea. No good equivalent exists and forcing one would misrepresent the era's own sense of time | Not attempted — flagged as a genuine mismatch |
| Catalogue | The palimpsest | Generations of figures overpainted/re-engraved on one panel | An unintentional archive, but a real one, at Chauvet and Lascaux both | Attested as a phenomenon; framing as "a catalogue" constructed |
| "Orbit" (title) | The dot-ring or spiral, undressed | No word — the mark stands alone | There is no wordmark to give it; keep the brand `ORBIT` as an out-of-fiction label rather than force a translation | Constructed (deliberately left untranslated) |
...
Kept as depictions of the same three rows and the same obscurer, per DANGERS.md option A — nothing
here is a new hazard, only a new name and a new drawing for an existing one.

| Row | Name | Drawn as |
|---|---|---|
| Attractor (VORAGO) | **The Shaft** (after Lascaux's own Puits) | A dark vertical drop rimmed by a pecked spiral; the pull is drawn as the eye being drawn down into it, not as a whirlpool |
| Repulsor (MACULA) | **The Flare** | A soot-blackened halo around an ember-red core — the scorch a guttering, over-fed torch leaves on a low ceiling |
| Crosswind (VENTUS) | **The Draught** | A streaked charcoal smear, dragged sideways, echoing a torch-flame bent by a real cave airflow — the same airflow cavers still follow to find hidden passages |
| Obscurer (nebula) | **Unlit rock** | Nothing drawn at all — the one hazard this era can depict with total fidelity, because the real thing already looks exactly like an absence of light |
...
1. **The Hall of the Bulls** — the four aurochs overlapping on bare rock, the six-dot cluster
   over the black bull's shoulder rendered exactly as ambiguous as it really is: present, real,
   and not claimed by the game as a confirmed star map.
2. **The Shaft Scene** — the dying bison, the fallen bird-headed figure, the bird-on-a-staff, used
   as the plate for the attractor chapter, over the literal vertical drop the scene is painted
   beside.
3. **Chauvet's shaded horses and the Panel of Hand Dots together** — the four superimposed horse
   heads, modelled with charcoal stump-shading (a genuinely attested technique, not invented for
   this document), alongside the palm-dabbed dot cluster as the era's own "constellation" of
   marks.
4. **Newgrange at solstice dawn** — the triple spiral kerbstone and the roofbox lit for its few
   real minutes of midwinter light, closing the era on its one uncontested astronomical fact
   rather than on a disputed one, and turning the page toward era I's Egypt.

## 11. Sound

- **Capture:** a stone-on-stone peck — the same gesture that cuts a cup mark, short and dry.
- **Release/flight:** a soft huff of breath — the blown-pigment stencil technique, air more than
  tone.
- **Perfect landing:** a low, resonant tone. Grounded (cautiously) in archaeoacoustic research,
  notably Iegor Reznikoff's studies correlating painted panel locations in French caves with
  points of unusually strong natural resonance — a real, if still-debated, line of inquiry, worth
  citing as inspiration rather than settled fact.
- **Graze:** a dry scrape, charcoal dragged rather than struck.
- **Loss:** a torch guttering out — a hiss, then the ambient drip and echo swelling up to fill the
  space light had been holding back.
- **Ambient bed:** water-drip, distant echo, a low crackle — the cave's own resting sound, present
  under everything else and never silent.
