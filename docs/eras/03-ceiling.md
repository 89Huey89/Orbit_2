...
carrying a naos and the solar disc above it, a block band along the sheer and two steering oars
crossed at the stern: no sail, which the funerary barques do not have either, since the sun is
rowed and steered rather than sailed. It rides its own heading rather than banking onto it,
