...
| VII · [The Flyby](07-flyby.md) | **LOS** | Loss of Signal, standard Deep Space Network and mission-operations usage, all-caps in the mnemonic style [LETTERING.md](LETTERING.md) already gives this era's telemetry hand — the honest name for what is actually happening (below), not a metaphor reaching for one. |
