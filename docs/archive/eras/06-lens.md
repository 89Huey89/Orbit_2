...
`docs/archive/eras/prototypes/plate.html` paints register two: a seeded 1280×800 sheet loading Courier
...
with per-glyph jitter instead. `docs/archive/eras/prototypes/observatory.html` paints register three:
