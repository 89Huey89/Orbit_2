...
|---|---|
| Every pull | `AUGUSTÆ VINDELICORUM` as the print place, `EX OFFICINA ORBIS TABULÆ` as the printer or publisher, `TAB. V · I` as the plate number, and `A1` as the sheet signature at lower right. The workshop name is deliberate game fiction; Augsburg is inherited from Bayer's signature sheet, not a claim about a historical printer. |
...
`AUGUSTÆ VINDELICORUM · EX OFFICINA ORBIS TABULÆ · TAB. V · I · A1`
