...
(`02-ceiling.md`), Era III (`03-scroll.md`), Era IV (`04-astrolabe.md`), Era VI (`06-lens.md`), Era VII (`07-flyby.md`) and
Era VIII (`08-probe.md`) are already playable, standalone preview doors reached from the frontispiece (`src/rock.js`,
`src/ceiling.js`, `src/scroll.js`, `src/astrolabe.js`, `src/lens.js`, `src/flyby.js`, `src/probe.js` — see root
`README.md`'s "The eras"). They ship on their own,
...
└── eras/                     the progression through the history of the star atlas, climbed
    ...
    ├── 08-probe.md           VIII · the far future — the self-replicating probe (preview, `src/probe.js`)
